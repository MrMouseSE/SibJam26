...
{
    [CreateAssetMenu(menuName = "Animations/ElementsAnimationDescription", fileName = "ElementsAnimationDescription", order = 0)]
    public class ElementsAnimationDescription : ScriptableObject
    {
        ...
        public float ElementSelectedDisappearDuration;
        public float ElementUnselectedDisappearDuration;
    }
}